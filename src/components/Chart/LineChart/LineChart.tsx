...
export const greenBackgroundGradient = (chartCtx: CanvasRenderingContext2D | null) => {
...
export const redBackgroundGradient = (chartCtx: CanvasRenderingContext2D | null) => {
...
export const backgroundGradients = (chartCtx: CanvasRenderingContext2D | null) => {
    return {
...
export const useFormatDataset = ({
    ...
    useCallback(({ dataset, label }): ChartDataset<'line', DataPoint[]> => {
        return {
            label,
            fill,
            data: dataset,
