...
export type ModalPortalElementFactory<T = undefined> = (
...
export const useModalPortal = <T,>(
  ...
  useEffect(() => {
    ...
    setModalPortal(createPortal(element, container.current))
  }, [container.current, element])

  useOnClickOutside(elementRef as MutableRefObject<Node>, (event) => {
    const didClickOutsideToggle = !(event.target as HTMLElement).closest(
